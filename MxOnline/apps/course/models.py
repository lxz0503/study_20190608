...
class Course(models.Model):
    ...
    def get_zj_nums(self):
        # 获取课程的章节数, lesson对应着一个Class,并且course是Class lesson中的一个外键
...
class Lesson(models.Model):
    ...
    # 定义外键course，因为一门course有多个章节lesson, 一对多
