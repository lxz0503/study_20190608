...
BUILDVIP=true
# must be assigned
git=/home/windriver/SPIN

wrenv=$git"/wrenv.linux -p vxworks-7 LM_LICENSE_FILE=27000@ala-lic4.wrs.com"
...
if $BUILDVSB; then
    ...
    $wrenv vxprj vsb add IPNET_DHCPS IPNET_FIREWALL  IPNET_IPSECIKE IPNET_ROUTEPROTO IPNET_IPSECIKE_GDOI IPNET_IPSECIKE_IKE SECURITY_MISC_SEC_CRYPTO 
    $wrenv make -j 8
fi
