...
def updateLtaf(dir):
    if os.path.isfile('/home/windriver/SPIN/vip_itl_generic/default/vxWorks'):
        r = calculate(dir)
        if r[1] > 1.0 or r[2] > 1.0:
            cp_cmd = "cp /home/windriver/ANVL/LTAF/test_result.log" + " " + dir
            os.system(cp_cmd)
        ...
        with open("test_result.log", "r") as fd:
            for line in fd.readlines():
                ...
                if case_status == "Passed":
                    ...
                    print
                    "Test case result is INCLUSIVE!Please check test log!"
                ...
                os.system(
                    "curl -F resultfile=@/home/windriver/ANVL/nightly.ini http://pek-lpgtest3.wrs.com/ltaf/upload_nightly_results.php")
