...
driver.find_element_by_css_selector("#tbody-01-K18053 > div.railway_list > div.w6 > div:nth-child(1) > a").click()
#如下步骤是为了实现不用登录到携程系统而实现订票的目的。
time.sleep(5)
driver.find_element_by_id("btn_nologin").click()
time.sleep(3)
#如下步骤是在订单信息页面输入乘客姓名信息
driver.find_element_by_css_selector("#pasglistdiv > div > ul > li:nth-child(2) > input").send_keys("小刘")
