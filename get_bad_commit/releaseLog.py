...
#modify  nightly.ini file
            ...
            config.read("/home/windriver/ANVL/release.ini")
            ...
            config.write(open('/home/windriver/ANVL/release.ini',"r+"))
            os.system("curl -F resultfile=@/home/windriver/ANVL/release.ini http://pek-lpgtest3.wrs.com/ltaf/upload_results.php")
            os.system("cp /home/windriver/ANVL/LTAF/release.ini /home/windriver/ANVL")
def main():
