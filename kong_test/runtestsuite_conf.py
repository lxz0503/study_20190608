#############################################################################
#
# Copyright (c) 2006-2014, 2017-2020 Wind River Systems, Inc.
#
...
#--------------------
#20may20,ply add firewall log testcase (VXWEXEC-50388)
#09apr20,yyl add dynamic helix config for ZCU102 (VXWEXEC-48814)
#18mar20,rza add SNMP_AGENTX for snmp case
#03mar20,yyl add to support directly connected boards (VXWEXEC-47902)
#23sep19,ply add fot ftp case
#01sep19,clb add to support helix
#13aug19,wbe upgrade to openssl-1.1.1 (VXWPG-105)
#02aug19,clb remove -DIPCOM_USE_SHELL=IPCOM_SHELL_IPCOM and USE_IPCOM_SHELL
#31jul19,jxy Shell prompt verify after shellPromptFmtDftSet (VXWEXEC-6644)
#10jul19,ply Modify for upgrade to openssl-1.1.1 (VXWPG-105)
...
testable_packages = {
    ...
    'SNMP' : {
        ...
        'vxconf'             : ['IPNET_IPCRYPTO', 'OPENSSL_CRYPTO', 'SNMP', 'FEATURE_SNMP_V3', 'SNMP_USE_SEC_KEY_DB', 'SNMP_USE_SSH_TRANSPORT', 'SNMP_USE_TLS_DTLS_TRANSPORT', 'IPNET_SSH', 'USER_MANAGEMENT', 'SECURITY_MISC_SEC_CRYPTO', 'FEATURE_SNMP_AGENTX'],
        'vxparam'            : [""" SEC_VAULT_KEY_ENCRYPTING_PW='"123456"'""", """ SNMP_TLS_KEY_ID='"snmpserver"'""", """ SNMP_TLS_KEY_FILE='"/ram/snmpserver.pem"'""", """ SNMP_TLS_CERT_FILE='"/ram/snmpserver.pem"'""", """ SNMP_TLS_CA_CERT_FILE='"/ram/root.pem"'""",  """ SNMP_TLS_CERT_SECNAME='"certSecName 10 4D:63:20:91:B2:CD:0A:B1:59:72:1A:F7:C8:56:A3:FC:09:F3:E1:65 --sn client.wrs.com"'""", 'SNMP_AGENTX_MAX_SESSIONS=1'],
        'vxprj'              : ['SNMP_MANAGER', 'SNMP_PRIVACY', 'WINDMANAGE_SNMP_CORE', 'SNMP_TLS_TRANSPORT', 'SNMP_DTLS_TRANSPORT', 'SNMP_SSH_TRANSPORT', 'IPCRYPTO', 'CCI_IMPORT_BLOWFISH', 'IPFTP_CMD', 'IPFTPS', 'SSH', 'IPCOM_KEY_DB_CMD', 'IPCOM_USE_KEY_DB', 'IPCRYPTO_USE_KEY_DB_EXAMPLE_KEYS', 'SECURITY', 'USER_MGT_SHELL_CMD', 'IPTFTP_CLIENT_CMD', 'WINDMANAGE_SNMP_AGENTX_MASTERCORE']
    },
    'EDOOM': {
        'capable'            : {
           'vxworks' : {}
    ...
    'FTP' : {
        ...
        'vxprj'              : ['IPFTP_CMD', 'IPFTPS', 'USER_DATABASE', 'SECURITY', 'IPCOM_USE_KEY_DB', 'IPCOM_KEY_DB_CMD','LOGIN_BANNER','IPTELNETS','TELNET_CLIENT'],
...
#        'extra_build_cflags' : ['-DPPPOE_MAX_ETH_SESSIONS="30"','-DINET6_RTHDR0=\\"enable\\"'],
    ...
    'OPENSSL_FIPS' : {
        ...
        'rtplib'             : ['-lssl', '-lcrypto', '-lcrypto_fips']
    },    
    'SSHCLIENT' : {
        'capable'            : {
            'vxworks' : {}
    ...
    'FIREWALL' : {
        ...
        'vxprj'              : ['IPFIREWALL_CMD', 'IPFTPS', 'IPNAT_CMD', 'KEYADM_CMD', 'IPCOM_USE_KEY_DB', 'IPCOM_KEY_DB_CMD','IPCOM_USE_TIME_CMD' ],
        'vxparam'            : [""" SEC_VAULT_KEY_ENCRYPTING_PW='"donald_duck"'"""]
    },
    'NET_VLAN' : {
        'capable'            : {
    ...
    'QOS' : {
        ...
        'vc'                 : ['ipnet2','qos'],
        'vxmake'             : ['VIRTUAL_ROUTER'],
        'vxconf'             : ['IPNET_QOS','IPNET_DIFFSERV', 'USER_MANAGEMENT'],
...
helixBuild = {
                 ...
                 'xlnx_zynqmp' :        { 'MIP'      : 'IPNET_S_ZYNQ',
                                          'dynamic'  : False,
                                          'image'    : 'uhypervisor',
                                          'dtb'      : 'xlnx-zcu102-rev-1.1.dtb',
                                        }, 
                 'xlnx_zynqmp_hvsafe' : { 'MIP'      : 'IPNET_S_ZYNQ_HVSAFE',
                                          'dynamic'  : False,
                                          'image'    : 'uhypervisor',
                                          'dtb'      : 'static_config.dtb',
                                        },
                 'xlnx_zynqmp_dynamic' : { 'MIP'      : 'IPNET_D_ZYNQ',
                                           'dynamic'  : True,
                                           'image'    : 'uVxWorks',
                                           'dtb'      : 'xlnx-zcu102-rev-1.1.dtb',
                                         },
...
helixHosts = {
    ...
    # setenv bootcmd "tftpboot 0x01000000 /folk/lchen3/tftpboot/helix28610/uhypervisor;tftpboot 0x0f000000 /folk/lchen3/tftpboot/helix28610/xlnx-zcu102-rev-1.1.dtb; bootm 0x01000000 - 0x0f000000"; setenv serverip 100.0.0.200; setenv ipaddr 100.0.0.2; setenv gatewayip 100.0.0.1; saveenv           
    'pek-kong-03' :   { 'direct_ethernet' : ( 'eno2', ),
                        'target' : ( '28610', ),
                        'vm'     : ( '192.168.199.12', ),
                        'tftp_client' : '10.0.0.2',
                        'tftp_server' : '10.0.0.200',
                        'tftp_path'   : '/folk/lchen3/tftpboot/helix/zcu102/',
                      },             
    # setenv bootcmd "tftpboot 0x01000000 /folk/yliu2/tftpboot/helix/zcu102_28623/uhypervisor;tftpboot 0x0f000000 /folk/yliu2/tftpboot/helix/zcu102_28623/static_config.dtb; bootm 0x01000000 - 0x0f000000"; setenv serverip 100.0.0.200; setenv ipaddr 100.0.0.2; setenv gatewayip 100.0.0.1; saveenv
    'pek-kong-04' :   { 'direct_ethernet' : ( 'eno2', ),
                        'target' : ( '28623', ),
                        'vm'     : ( '192.168.199.12', ),
                        'tftp_client' : '10.0.0.2',
                        'tftp_server' : '10.0.0.200',
                        'tftp_path'   : '/folk/yliu2/tftpboot/helix/zcu102_28623/',
                      },
}

# direct config
directTargets = {
    'xlnx_zynqmp' : { 'image' : 'uVxWorks',
                      'dtb'   : 'xlnx-zcu102-rev-1.1.dtb',
                      'dts'   : '/os/board/xilinx/xlnx_zynqmp/xlnx-zcu102-rev-1.1.dts',
                    },
}
...
directHosts = {
    'pek-kong-04' :   { 'direct_ethernet' : ( 'eno2', ),
                        'target' : ( '28623', ),
                        'addr'   : ( '192.168.199.2', ),
                        'tftp_client' : '192.168.199.2',
                        'tftp_server' : '192.168.199.1',
                        'tftp_path'   : '/net/pek-vx-nwkstage/workspace/tftpboot/direct/zcu102_28623',
                      },
}
