...
#buildOps="-dontcopyhosttool -nobuild -tests 4.1"
buildOps="-tests 4.1 -buildonly"
#buildOps="-dontcopyhosttool -nobuild"
#buildOps=""
#buildOps="-dontcopyhosttool -nobuild -tests 4.0,4.1"

dvdPath="/workspace/wdeng/vx7/vxworks -buildserver target:vxTarget@pek-dliu4-u1"
...
./runTest.tcl -suite $testSuite -suitedir $suiteDir -path $dvdPath -vxworks oak -syslog 3 -caselog 2 -productinclude 6.9.2.f0 $dockerDNS $buildOps \
-64bit -target cpu=NEHALEM,bsp=itl_generic,tool=llvm,portSrv=128.224.164.51:2012,pduSrv=128.224.164.166:8,bootdev=gei5,eif=eth3,ftp=windriver,passwd=windriver \
