...
# coding: utf-8
#
# refer to Jenkins script:
# # run p2020 up
# . /net/pek-vx-system1/buildarea1/hyan1/wassp/nightly_config.ini
# PLAN='/folk/hyan1/wassp/iPerf_up/07_fsl_ppc_18491_p2020rdb.xls'
# python3 /folk/hyan1/Nightly/iPerf_up/iPerf_run.py --plan $PLAN --dvd $DVD --release $LTAFRELEASE --rundate $RUNDATE
import os
