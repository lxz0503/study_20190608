...
import argparse
from iPerf_run_database import get_config
...
def main():
	...
	upload_command = 'python3 /folk/hyan1/Nightly/common/load_ltaf_ssl.py --log {LOG} --rundate {RUNDATE} --release {RELEASE}'.format( LOG= logs, RUNDATE = week, RELEASE = release)
